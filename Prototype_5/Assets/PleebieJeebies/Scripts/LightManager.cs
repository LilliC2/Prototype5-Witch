...
public class LightManager : GameBehaviour<LightManager>
{
    ...
    [SerializeField, Tooltip("How fast time will go")] public float TimeMultiplier = 1;
    ...
    private void Update()
    {
        ...
        if (TimeOfDay >= 10 && TimeOfDay <= 15) dayAdded = false;
    }
